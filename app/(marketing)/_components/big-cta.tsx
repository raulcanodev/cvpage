    ...
    <div className="min-h-screen flex flex-col bg-blue-600">
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <Button 
            asChild
            className="bg-white text-blue-600 hover:bg-blue-50 text-lg py-6 px-8 rounded-full font-semibold transition-colors duration-300"
          >
            <Link href="/signup">
      ...
      <footer className="py-6 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center text-blue-100">
